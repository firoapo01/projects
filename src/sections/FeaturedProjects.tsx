        ...
        {projects.map((project) => (
          <motion.div key={project.slug} variants={fadeUp}>
            <Link
              ...
              className="group flex h-full flex-col gap-3 rounded-xl border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] p-6 transition-shadow duration-base hover:shadow-md"
            >
